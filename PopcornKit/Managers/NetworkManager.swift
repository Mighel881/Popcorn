...
public struct PopcornShows {
    static let base = NSDictionary(contentsOf: URL(string: "https://raw.githubusercontent.com/antiquebeta/getpopcorn.app/master/PopcornAPI.plist")!)?.value(forKey: "popcorn_show_base") as! String  // "https://tv-v2.api-fetch.sh"
    static let shows = "/shows"
    static let show = "/show"
}

public struct PopcornMovies {
    static let base = NSDictionary(contentsOf: URL(string: "https://raw.githubusercontent.com/antiquebeta/getpopcorn.app/master/PopcornAPI.plist")!)?.value(forKey: "popcorn_movie_base") as! String  // "https://movies-v2.api-fetch.sh"
    static let movies = "/movies"
...
open class NetworkManager: NSObject {
    ...
    public enum MovieGenres: String {
        ...
        public static var array = [all, action, adventure, animation, anime, comedy, crime, disaster, documentary, drama, family, fanFilm, fantasy, filmNoir, history, holiday, horror, indie, music, mystery, road, romance, sciFi, short, sports, sportingEvent, suspense, thriller, war, western]
